...
/* Attemp to load a server module with the name MODULE_PATH. If a
  server module exists with the path, loads the module and returns a
  server_module structure representing it. Otherwisem returns NULL */
